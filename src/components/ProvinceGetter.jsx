...
const ProvinceGetter = ({ province, district, setProvince, setDistrict, setWard, setWardSelected, setDistrictSelected, info, setInfo, result, setResult, isAddressImported, setIsAddressImported }) => {
