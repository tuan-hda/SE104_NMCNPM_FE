      ...
      <div className='w-3/5'>
        ...
        <div className='mt-9 text-13'>
          ...
          <div className='flex justify-between gap-2'>
            {/* Province */}
            <select className='mt-4 delivery-input font-semibold' type='text' placeholder='Province' name='province' value={deliveryInfo.province} onChange={handleChange} >
              <option defaultChecked={true} disabled>Choose province</option>
            </select>

            {/* District */}
            <select className='mt-4 delivery-input font-semibold' type='text' placeholder='District' name='district' value={deliveryInfo.district} onChange={handleChange} >
              <option defaultChecked={true} disabled>Choose district</option>
            </select>

            {/* Ward */}
            <select className='mt-4 delivery-input font-semibold' type='text' placeholder='Ward' name='ward' value={deliveryInfo.ward} onChange={handleChange}>
              <option defaultChecked={true} disabled>Choose ward</option></select>
          </div>
