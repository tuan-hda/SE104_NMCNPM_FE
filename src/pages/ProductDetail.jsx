    ...
    <div className='grid grid-cols-2 pt-14 px-32 gap-10 justify-between'>
      ...
      <div className='bg-gray-thumb rounded-lg w-[750px] h-[500px] grid place-content-center'>
        <img
          ...
          className='h-[500px] object-contain self-center'
        />
      </div>
      {/* Product Detail */}
      <div className='grid place-self-end h-full grid-rows-2 w-[600px]'>
        ...
        <div className='grid'>
          ...
          <div className='grid grid-cols-2 justify-between items-center'>
            ...
            <div className='grid grid-cols-3 place-items-end'>
              ...
              <input
                className=' w-10 h-10 placeholder-black-placeholder
        ...
        <button
          ...
          className='hidden md:flex items-center justify-center bg-secondary text-5xl text-white font-medium rounded-[50px] w-50 h-20 px-10'
        >
          Add to Cart
        </button>
      </div>
