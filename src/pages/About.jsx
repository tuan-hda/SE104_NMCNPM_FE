...
const About = () => {
  return (
    <div className='px-2 sm:px-8 md:px-16 xl:px-32 py-32'>
      {/* About */}
      <div className='flex gap-24'>
        <div className='w-1/2'>
          <h1 className='font-bold text-[90px] text-[#202124] pt-20'>
            IF YOU LIKE HAMBURGER, THIS IS WHY
          </h1>
          <div className=' w-3/5 mt-32'>
            ...
            <p className='mt-4'>
              We make delicious hamburgers. If they ever make a food hall of
              fame, our hamburger is gonna be a first-ballot inductee.
            </p>
          </div>
        </div>
        <div className=''>
      ...
      <div className='flex gap-24 mt-20'>
        ...
        <div className='mt-32'>
          ...
          <p className='mt-8'>
            Hambursy is a fast-food restaurant chain, came from Vietnam.
            Hambursy’s parent company is Hambursy Co.–The largest food
            corporation in Ho Chi Minh City, Vietnam. (Hambursy, 2022){' '}
          </p>
        </div>
      </div>
      {/* History */}
      <div className='flex gap-24 mt-20 flex-row-reverse'>
        ...
        <div className=' w-1/3 mt-10'>
          ...
          <p className='mt-12 text-right'>
            It all began with the girl, the myth, the legend herself. In 2002,
            in a humble service station in Saigon, Vietnam, 19-year old Thu
            Trang began feeding hungry travellers. Trang Pham spent the next
            nine years (now that's dedication) perfecting her secret blend of 11
            herbs and spices, as well as the basic cooking technique we still
            use today. In 2020, she founded a chain of restaurants called
            ‘Hambursy’. There are now over 2,000 Hambursy outlets in more than
            30 provinces around Vietnam.{' '}
          </p>
        </div>
      </div>
    </div>
